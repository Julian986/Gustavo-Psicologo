...
const testimonios: Testimonio[] = [
	{
		nombre: 'Juan P.',
		texto: 'Me sentí escuchado y contenido desde la primera sesión. Noté avances reales.',
		rating: 5,
		fecha: 'Jun 2024',
		fuente: 'Google',
	...
	{
		nombre: 'Ana G.',
		texto: 'Un espacio profesional y cálido que me ayudó a ordenar mis emociones.',
		rating: 5,
		fecha: 'Abr 2024',
		fuente: 'Google',
	...
	{
		nombre: 'Marcos L.',
		texto: 'Herramientas prácticas para el día a día. Lo súper recomiendo.',
		rating: 5,
		fecha: 'Ene 2024',
		fuente: 'Google',
  ...
  return (
    <section id="testimonios" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-2 text-slate-600 text-center max-w-2xl mx-auto">Lo que dicen quienes ya trabajaron conmigo.</p>
